  ...
  return (
    <div >
      ...
      className="mx-auto max-w-xl rounded-2xl bg-white p-6 shadow-lg">
        ...
        <h1 className="mb-2 text-3xl font-bold text-gray-800">Add a Blog</h1>

        <p className="mb-6 text-gray-500">Share your thoughts and experiences.</p>

        {/* Title */}

        <div className="mb-4">
          <label className="mb-2 block font-medium text-gray-700">Blog Title</label>
        ...
        {/* Summary */}
        <div className="mb-4">
          <label className="mb-2 block font-medium text-gray-700">Blog Summary</label>
